...
export default function OrderFilesAndSpecs({ order }) {
          ...
          <div className="p-8 space-y-6 animate-in slide-in-from-right-2 duration-500">
            {designAssets.length > 0 ? (
              ...
              <div className="h-[400px] flex flex-col items-center justify-center bg-base-50/50 rounded-3xl border-2 border-dashed border-base-200 text-center px-8">
                ...
                <p className="text-[10px] font-bold text-base-content/30 max-w-[200px] uppercase tracking-tight leading-snug">You didn't attach any additional design files with this order.</p>
              </div>
            )}
          </div>
        )}
            ...
            {sizeChartUrl ? (
              <>
                ...
                <div className="flex items-center justify-between p-5 bg-white rounded-2xl border border-base-200 shadow-sm">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-[10px] font-bold text-base-content/30 uppercase tracking-widest mb-0.5">Your Size Chart</p>
              ...
              <div className="h-[400px] flex flex-col items-center justify-center bg-base-50/50 rounded-3xl border-2 border-dashed border-base-200 text-center px-8">
                ...
                <p className="text-[10px] font-bold text-base-content/30 max-w-[220px] uppercase tracking-tight leading-snug">
                  {isCustomSizing
                    ? 'You did not attach a size chart file with this order.'
                    : 'This order uses the default Factory standard size chart. No custom file was provided.'}
                </p>
              </div>
            )}
          </div>
