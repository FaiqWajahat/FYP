            ...
            <tbody className="divide-y divide-base-100">
              {filteredOrders.length > 0 ? (
                filteredOrders.map((order) => {
                  ...
                  const displayId = order.display_id ? `${order.display_id}` : order.id.slice(0, 8);
                  const productName = order.product_name || order.product?.name || 'Custom order';
                    ...
                    <tr key={order.id} className="hover:bg-base-50/50 transition-all duration-300 group">
                      ...
                      <td className="py-8 pl-10">
                        <div className="flex items-center gap-4">
                          ...
                          <div className="space-y-1">
                            <p className="font-black text-base text-base-content tracking-tight leading-none"> #ORD-{1000 + (displayId || 0)}</p>
