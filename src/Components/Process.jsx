        ...
        <div className="mt-16 text-center">
          <Link href="/smart-inquiry">
            <motion.button 
              ...
              whileTap={{ scale: 0.95 }}
              className="inline-flex items-center gap-2 px-8 py-4 bg-slate-900 text-white rounded-full font-bold text-lg shadow-xl hover:bg-blue-700 transition-colors"
            >
