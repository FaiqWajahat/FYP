...
export default function EditUserPage() {
  ...
  const breadData = [
    ...
    { name: 'Users', href: '/admin/Users/All' },
    { name: 'Edit User', href: `/admin/Users/Edit/${id}` },
  ];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 w-full">
         ...
         <div className="lg:col-span-4 space-y-8">
            <div className="bg-slate-900 text-white p-8 rounded-3xl shadow-xl shadow-blue-900/10">
               ...
               <button onClick={() => router.push('/admin/Users/All')} className="w-full py-4 bg-white/5 hover:bg-white/10 border border-white/10 rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] transition-all">
                  Back to User List
               </button>
            </div>
         </div>
